<?php
    ...
    function executeDatabaseQueries($conn , $databaseQueryStringsArray) {
        ...
        $allArrayOfArraysOfArrays = ['equipmentArrayOfArrays' => $equipmentArrayOfArrays, 'iP_AndPortsArrayOfArrays' => $iP_AndPortsArrayOfArrays, 'linksArrayOfArrays' => $linksArrayOfArrays, 'locationsArrayOfArrays' => $locationsArrayOfArrays, 'passwordArrayOfArrays' => $passwordArrayOfArrays, 'serverArrayOfArrays' => $serverArrayOfArrays];
