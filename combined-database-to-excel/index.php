<?php
    ...
    function outputAllDatabaseToExcel($allArrayOfArraysOfArrays){  
        $fileName = "it_inventory_combined_data.xls";
        header("Content-Disposition: attachment; filename=\"$fileName\"");
        header("Content-Type: application/vnd.ms-excel");
        foreach($allArrayOfArraysOfArrays as $key => $arrayOfArrays){
            echo "$key" . "\n";
            foreach($arrayOfArrays as $subKey => $array) {
                echo "$subKey";
        ...
        //$fileName = "it_inventory_all_data.xls";
        //header("Content-Disposition: attachment; filename=\"$fileName\"");
        //header("Content-Type: application/vnd.ms-excel");
        //echo implode("\t", array_keys($allArrayOfArraysOfArrays[0])) . "\n";
    ...
    function outputArraysToExcel($allArrayOfArraysOfArrays){        
        ...
        outputAllDatabaseToExcel($allArrayOfArraysOfArrays);
    }
