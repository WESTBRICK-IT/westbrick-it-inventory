...
<head>
    ...
    <title>Westbrick IT Inventory - Add New Password</title>
...
<body>
    <?php
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo    "<img class='westbrick-success-svg' src='../../images/password-submitted-successfully.svg' alt='WESTBRICK SUCCESS SVG'>";
