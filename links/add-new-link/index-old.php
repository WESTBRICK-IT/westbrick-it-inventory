...
<body>
    ...
    <form class="submission-form" method="post" action="add-new-link.php" enctype="multipart/form-data"> 
        ...
        <?php
            ...
            echo "      <select class='dropdown select1 location-select1-dropdown' id='select1-location' name='select1-location' required>";
            for($i = 0; $i < mysqli_num_rows($result); $i++) {                             
        ...
        <?php
            ...
            echo "      <select class='dropdown select2 location-select2-dropdown' id='select2-location' name='select2-location' required>";
            for($i = 0; $i < mysqli_num_rows($result); $i++) {                             
