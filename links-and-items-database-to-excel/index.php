<?php
    ...
    function outputAllDatabaseToExcel($allArrayOfArraysOfArrays, $conn){  
        $arrayOfUserComputerIPToBePrinted = [];
        $arrayOfUserComputerIPToBePrinted = getTheArrayOfItemsForExcelOutput($allArrayOfArraysOfArrays, $conn, $arrayOfUserComputerIPToBePrinted);                
    }
    function outputArraysToExcel($allArrayOfArraysOfArrays, $conn){
        outputAllDatabaseToExcel($allArrayOfArraysOfArrays, $conn);
    }
